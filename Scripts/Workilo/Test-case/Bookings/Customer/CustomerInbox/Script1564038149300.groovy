...
List<WebElement> element = driver.findElements(By.xpath('/html/body/div[6]/div/div/div[2]/div[2]/div/ul/li'))

System.out.println('Total List == ' + element.size())

for (int i = 0; i < (element.size() - 1); i++) {
    js.executeScript('arguments[0].style.border=\'3px solid red\'', driver.findElement(By.xpath(('/html/body/div[6]/div/div/div[2]/div[2]/div/ul/li[' + 
                (i + 1)) + ']')))
}

js.executeScript('window.scrollTo(0, document.body.scrollHeight)')

List<WebElement> paymentList = driver.findElements(By.xpath('/html/body/div[6]/div/div/div[2]/div[3]/div/ul/li'))

System.out.println('Payment List == ' + paymentList.size())

for (int i = 0; i < paymentList.size(); i++) {
    js.executeScript('arguments[0].style.border=\'3px solid red\'', driver.findElement(By.xpath(('/html/body/div[6]/div/div/div[2]/div[3]/div/ul/li[' + 
                (i + 1)) + ']')))
}
