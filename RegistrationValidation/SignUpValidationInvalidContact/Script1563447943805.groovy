...
Thread.sleep(2000);
driver.findElement(By.id("email")).sendKeys("shahbaz.dapl1@gmail.com");
driver.findElement(By.id("firstName")).sendKeys("Shahbaz");
driver.findElement(By.id("lastName")).sendKeys("Farooque");
driver.findElement(By.id("password")).sendKeys("admin#123");
driver.findElement(By.id("contact_number")).sendKeys("abcdefghij");
driver.findElement(By.xpath(".//*[@value='Sign Up']")).click();
Thread.sleep(2000);
WebElement errorMessage = driver.findElement(By.xpath("//*[@id='signup-form']/div[4]/label[2]"));
