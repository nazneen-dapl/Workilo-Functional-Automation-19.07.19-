...
driver.findElement(By.xpath('/html/body/div[6]/div/div/div[1]/div/div/ul/li[5]/a')).click()

Thread.sleep(1000)

String message = driver.findElement(By.xpath('/html/body/div[6]/div/div/div[1]/div/div/ul/li[5]/a')).getText()
