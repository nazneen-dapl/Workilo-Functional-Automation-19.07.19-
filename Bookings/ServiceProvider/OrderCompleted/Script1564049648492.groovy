...
driver.findElement(By.xpath('/html/body/div[6]/div/div[1]/div[1]/div/div/ul/li[3]/a')).click()

String message = driver.findElement(By.xpath('/html/body/div[6]/div/div[1]/div[1]/div/div/ul/li[3]/a')).getText()
...
if (message.contains('(0)')) {
	...
	List<WebElement> rows = driver.findElements(By.xpath('//*[@id=\'tab-3\']/table/tbody/tr'))
	...
	for (int i = 0; i < rows.size(); i++) {
		...
		String orderValue = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[1]')).getText()

		String addressValue = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[2]')).getText()
		
		String listingValue = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[3]')).getText()
		
		String bookingDateValue = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[4]')).getText()
		
		String statusValue = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[5]')).getText()
		
		String paymentValue = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[6]')).getText()
		
		WebElement order = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[1]'))
		
		WebElement address = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[2]'))
		
		WebElement listing = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[3]'))
		
		WebElement bookingDate = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[4]'))
		
		WebElement status = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[5]'))
		
		WebElement paymentStatus = driver.findElement(By.xpath(('//*[@id=\'tab-3\']/table/tbody/tr[' + (i + 1)) + ']/td[6]'))
		...
		Assert.assertNotEquals(statusValue, null,"Status value is null")
